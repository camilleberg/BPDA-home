...
# Adjusted Overall Spending

+ used weighted mean of selected items as "overall spending" inflation index instaed  of "All ITems"


```{r}
# loading in data
txn_amt_adj <- read_xlsx(paste0(proj_folder_dir, "/in_person_spending_ret.xlsx"), sheet = "txn_amt_adj")
txn_amt <- read_xlsx(paste0(proj_folder_dir, "/in_person_spending_ret.xlsx"), sheet = "txn_amt")
txn_cnt <- read_xlsx(paste0(proj_folder_dir, "/in_person_spending_ret.xlsx"), sheet = "txn_cnt")
