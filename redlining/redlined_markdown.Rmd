...
t.test(tracts_ownership %>% filter(prop75 == "rl") %>% select(ownership_rate), 
       tracts_ownership %>% filter(prop75 != "rl") %>% select(ownership_rate))
```
...
t.test(tracts_ownership %>% filter(prop90 == "rl") %>% select(ownership_rate), 
       tracts_ownership %>% filter(prop90 != "rl") %>% select(ownership_rate))
```
